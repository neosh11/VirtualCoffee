...
export default function Careers() {
  return (
    <div className='relative lg:py-16 bg-white'>
      ...
      <div className='max-w-7xl mx-auto bg-red-600 lg:bg-transparent lg:px-8 py-8'>
        <div className='lg:grid lg:grid-cols-12'>
          ...
          <div className='relative bg-red-600 lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center'>
